...
const copy_replace_State_files = async (
    ...
    let new_state_h = state_h.toString().replace("-___author___-", author)
    ...
    let new_state_c = state_c.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str)
    ...
    let new_highstate_c = highstate_c.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str)
        .replace("-___all_probes_chain___-", all_probes_chain)
        .replace("-___all_save_values_chain___-", all_save_values_chain)
        .replace("-___high_sensing_and_aggregation_code___-", high_sensing_and_aggregation_code)
    ...
    let new_highstate_h = highstate_h.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str);
    ...
    let new_lowstate_c = lowstate_c.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str)
        .replace("-___all_probes_chain___-", all_probes_chain)
        .replace("-___all_save_values_chain___-", all_save_values_chain)
        .replace("-___low_sensing_and_aggregation_code___-", low_sensing_and_aggregation_code)
    ...
    let new_lowstate_h = lowstate_h.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str);
...
const copy_replace_Makefile = async (
    ...
    let new_makefile = makefile.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str)
...
const copy_replace_Main_file = async (
    ...
    let new_main_c = main_c.toString().replace("-___author___-", author)
        .replace("-___date___-", date_str)
        .replace("-___all_sensors_includes___-", all_sensors_includes)
        ...
        .replace("-___all_receiving_structs___-", all_receiving_structs)
        .replace("-___reception_code___-", reception_code)
        .replace("-___all_sensing_threads_funcitons_definition___-", all_sensing_threads_funcitons_definition)
        .replace("-___prepare_output_string_and_change_to_high_state_condition___-", prepare_output_string_and_change_to_high_state_condition)
        .replace("-___generation_unix_time___-", Date.now())
        .replace("-___init_all_sensors___-", init_all_sensors)
        .replace("-___create_all_sensing_and_transformation_threads___-", create_all_sensing_and_transformation_threads);
